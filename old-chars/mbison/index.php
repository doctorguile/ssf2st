...
$character = new Character('M.Bison', DOWN . UP . UP . DOWN);
...
$character->addMoveset(
  'Scissor Kicks', SPECIAL, movesetImages("./special-5/*.jpg"), "13+8, 14+8, 15+8", STANDING | CROUCHING, KNOCKDOWN,
  array(BF, KICK), array(
...
$character->addMoveset(
  'Head Stomp', 
  SPECIAL, movesetImages("./special-2/*.jpg"), "12, 13, 15", STANDING | CROUCHING, 'Pushback + Knockdown',
  array(DU,KICK),
array(30,UNTIL_LAND)
);
...
$character->addMoveset(
  ...
  SPECIAL, movesetImages("./special-4/*.jpg"), "16, 19, 19", STANDING | CROUCHING, 'Pushback + Knockdown',
  array('airborne', PUNCH),
  array(
array(3,UNTIL_LAND,6),
array(4,20,UNTIL_LAND,SKIP,6),
array(6,8,UNTIL_LAND,SKIP,6)
)
);


$character->addMoveset(
  'Devil Reverse', SPECIAL, movesetImages("./special-3/*.jpg"), "17, 18, 20", STANDING | CROUCHING, KNOCKDOWN,
  array(DU,PUNCH, ' after airborne', PUNCH),
  array(
  array(53,12,6,SKIP,6),
array(53,13,5,SKIP,8),
array(53,14,5,SKIP,10)
)
);
...
$character->movesets["close-mp"]->frames  = array(3,4,SKIP,4,9);
$character->movesets["close-hp"]->frames  = array(9,6,20);      
$character->movesets["close-lk"]->frames  = array(3,3,0);       
$character->movesets["close-mk"]->frames  = array(3,4,SKIP,4,9);
$character->movesets["close-hk"]->frames  = array(7,6,18);      
$character->movesets["far-lp"]->frames    = array(4,4,5);       
$character->movesets["far-mp"]->frames    = array(3,4,SKIP,4,9);
$character->movesets["far-hp"]->frames    = array(9,6,20);      
...
$character->movesets["crouch-mp"]->frames = array(5,4,9);       
$character->movesets["crouch-hp"]->frames = array(9,6,20);      
...
$character->movesets["jump-mp"]->frames   = array(3,20,24);     
