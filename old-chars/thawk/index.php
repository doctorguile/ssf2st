...
$character = new Character('T.Hawk', RIGHT . RIGHT . LEFT . LEFT);
...
$character->addMoveset(
  'Rising Hawk (Tomahawk Buster)', SPECIAL, movesetImages("./special-1/*.jpg"), "20,20,20+9", STANDING | CROUCHING, KNOCKDOWN,
...
$character->addMoveset(
  'Condor Dive', SPECIAL, movesetImages("./special-2/*.jpg"), "11,11,12", STANDING | CROUCHING, KNOCKDOWN,
  array(PPP), array(17,UNTIL_LAND,11,SKIP,10)
);

$character->addMoveset(
  'Mexican Typhoon', SPECIAL, movesetImages("./special-3/*.jpg"), "27,30,32", null, null,
...
$character->movesets["crouch-hk"]->frames = array(7,7,6,8,23);
...
$character->movesets["jump-hp"]->frames   = array(5,2,SKIP,11,23);
