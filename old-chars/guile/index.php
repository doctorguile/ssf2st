...
$character = new Character('Guile', UP . DOWN  . DOWN  . DOWN);

addStandardMovesets($character);

$character->addMoveset(
  'Upside down kick', UNIQUE, movesetImages("./unique-1/*.jpg"), 16, STANDING | CROUCHING, PUSHBACK,
  array(LEFT,'/',RIGHT,' + ', HK), array(16,6,16)
);

$character->addMoveset(
  'Bazooka Knee', UNIQUE, movesetImages("./unique-2/*.jpg"), 14, STANDING | CROUCHING, PUSHBACK,
...
$character->movesets["close-hk"]->frames  = array(8,4,9);      
$character->movesets["far-lp"]->frames    = array(4,4,5);      
$character->movesets["far-mp"]->frames    = array(3,2,13);     
$character->movesets["far-hp"]->frames    = array(10,5,18);    
$character->movesets["far-lk"]->frames    = array(5,4,6);      
$character->movesets["far-mk"]->frames    = array(10,5,13);    
$character->movesets["far-hk"]->frames    = array(9,5,14);     
