...
$character = new Character('Fei Long');
...
$character->addMoveset(
  'Chicken Wing', SPECIAL, movesetImages("./special-3/*.jpg"), "8+3+8, 9+3+8, 10+3+10", STANDING, PUSHBACK,
  array(HCF, UPFORWARD, KICK), array(
array(20,12,SKIP,4,SKIP,3,13),
array(20,12,SKIP,5,SKIP,4,11),
array(21,12,SKIP,6,SKIP,5,10))
);

$character->addMoveset(
  'Super', SUPER, movesetImages("./super/*.jpg"), "8+8+8+8+8+8", STANDING | CROUCHING, 'Last hit Knockdown',
  array(QCF,QCF,PUNCH),
  array(1,SKIP,17,SKIP,8,3,7,7,5,3,7,7,11,6,23)
);
...
$character->movesets["close-hp"]->frames  = array(4,4,SKIP,10,6);
...
$character->movesets["jump-mp"]->frames   = array(3,8,30);
$character->movesets["jump-hp"]->frames   = array(5,6,30);
$character->movesets["jump-lk"]->frames   = array(3,20,18);
$character->movesets["jump-mk"]->frames   = array(3,10,28);
$character->movesets["jump-hk"]->frames   = array(5,8,28);
