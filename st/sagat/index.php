...
$character->addMoveset(
  ...
  array(QCF, PUNCH), array(array(11,SKIP,37),array(11,SKIP,39),array(11,SKIP,41))
);
...
$character->addMoveset(
  ...
  array(QCF,DOWN,DOWNFORWARD,PUNCH),
  array(1,SKIP,17,SKIP,6,3,SKIP,3,SKIP,6,16,4,SKIP,3,SKIP,27,23,SKIP,9)
);
...
$character->movesets["close-mp"]->frames  = array(4,6,7);         
$character->movesets["close-hp"]->frames  = array(4,8,11);        
