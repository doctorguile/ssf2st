...
$character->addMoveset(
  'Overhead', UNIQUE, movesetImages("./unique-1/*.jpg"), '18+3', STANDING , PUSHBACK,
  array(RIGHT, MP), array(17,2,SKIP,9,4)
);

$character->addMoveset(
  'Rush Punch', UNIQUE, movesetImages("./unique-2/*.jpg"), '18+3', STANDING | CROUCHING, PUSHBACK,
  array(RIGHT, HP), array(11,1,SKIP,8,6)
);

$character->addMoveset(
  'Hadouken (fire ball)', SPECIAL, movesetImages("./special-1/*.jpg"), "10, 11, 12", STANDING | CROUCHING, PUSHBACK,
  array(QCF, PUNCH), array(
array(11,SKIP,40),
array(11,SKIP,41),
array(11,SKIP,42)
)
...
$character->addMoveset(
  'Fire Hadouken (fire ball)', SPECIAL, movesetImages("./special-2/*.jpg"), "10, 11, 12", STANDING | CROUCHING, PUSHBACK,
...
$character->addMoveset(
  'Shoryuken (Uppercut)', SPECIAL, movesetImages("./special-3/*.jpg",CLEARDIV,"./special-6/*.jpg"), "18, 18+11, 18+11", STANDING | CROUCHING, KNOCKDOWN,
  array(DP, PUNCH), array(
array(4,4,SKIP,2,SKIP,8,21,SKIP,5),
array(4,4,SKIP,2,SKIP,12,28,SKIP,5),
array(4,4,SKIP,2,SKIP,16,35,SKIP,5)
)
);

$character->addMoveset(
  'Hurricane Kick', SPECIAL, movesetImages("./special-4/*.jpg"), "15, 15, 16", STANDING | CROUCHING, KNOCKDOWN,
  array(QCB,KICK),
  array(
array(11,3,3,3,15,SKIP,0),
array(11,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,15,SKIP,0),
array(11,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,15,SKIP,0)
)
);
...
$character->addMoveset(
  'Super', SUPER, movesetImages("./super/*.jpg"), "10+10+10+10+10", STANDING | CROUCHING, 'Last hit Knockdown',
  array(QCF,QCF,PUNCH),
  array(10,SKIP,17,SKIP,2,SKIP,40)
);
...
$character->movesets["far-hk"]->superCancel = true;
...
$character->movesets["far-lk"]->frames    = array(5,8,5);   
...
$character->movesets["jump-mp"]->frames   = array(4,5,SKIP,8,26); 
