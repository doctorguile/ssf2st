...
$character = new Character('Blanka');
...
$character->addMoveset(
  ...
  array(LEFT, '/',  RIGHT, MP), array(4,4,SKIP,3,SKIP,2,12), false, true, true
);

$character->addMoveset(
  'Slide', UNIQUE, movesetImages("./unique-2/*.jpg"), '17',  CROUCHING, KNOCKDOWN,
  array(DOWNFORWARD, HP), array(12,16,20)
);

$character->addMoveset(
  'Dash Forward', SPECIAL, movesetImages("./special-1/*.jpg"), '&nbsp;', NULL, NULL,
  array(FORWARD, KKK), array(26)
);

$character->addMoveset(
  'Dash Backward', SPECIAL, movesetImages("./special-2/*.jpg"), '&nbsp;', NULL, NULL,
  array(LEFT, KKK), array(26)
);


$character->addMoveset(
  'Blanka Ball', SPECIAL, movesetImages("./special-4/*.jpg", CLEARDIV, 'On hit',"./special-7/*.jpg"), '17,19,20', STANDING | CROUCHING, PUSHBACK,
  array(BF, PUNCH), array(array(SKIP,25,3),array(SKIP,25,3),array(SKIP,60,3))
);

$character->addMoveset(
  'Up Ball', SPECIAL, movesetImages("./special-5/*.jpg"), '17,17,18', STANDING | CROUCHING, PUSHBACK,
  array(DU, PUNCH), array(array(SKIP,30,3,4,SKIP,4,11,SKIP,6),array(SKIP,29,3,4,SKIP,4,11,SKIP,7),array(SKIP,28,3,4,SKIP,4,15,SKIP,8))
);

$character->addMoveset(
  'Jump back ball', SPECIAL, movesetImages("./special-6/*.jpg"), '8+8+8+17,17,17', STANDING | CROUCHING, PUSHBACK,
  array(BF, KICK), array(
...
$character->addMoveset(
  'Electricity', SPECIAL, movesetImages("./special-3/*.jpg"), "16,17,19", STANDING | CROUCHING, 'Electrified',
...
$character->addMoveset(
  'Super', SUPER, movesetImages("./super/*.jpg"), "12+12+12+12+12", STANDING | CROUCHING, 'Last hit Knockdown',
  array(LEFT,RIGHT,LEFT,RIGHT,PUNCH, ' Optional: holding and releasing', PUNCH), 
array(array(1,SKIP,17,SKIP,13,28,SKIP,'Until release',28,SKIP,8),
array(1,SKIP,17,SKIP,13,28,SKIP,'Until release',19))
);
